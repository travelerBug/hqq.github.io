<template><div><h1 id="_1-命令" tabindex="-1"><a class="header-anchor" href="#_1-命令" aria-hidden="true">#</a> 1. 命令</h1>
<p>假如你已安装了golang环境，你可以在命令行执行go命令查看相关的Go语言命令：</p>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>$ go
...
</code></pre></div><p>go env用于打印Go语言的环境信息。</p>
