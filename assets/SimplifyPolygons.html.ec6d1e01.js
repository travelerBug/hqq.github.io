import{_ as l,o,c as i,e as s}from"./app.924ef5e2.js";const e={},p=s(`<h3 id="simplifypolygons" tabindex="-1"><a class="header-anchor" href="#simplifypolygons" aria-hidden="true">#</a> <strong>SimplifyPolygons</strong></h3><div class="language-text ext-text"><pre class="language-text"><code>Del.\xBB function SimplifyPolygons(const polys: TPaths; 
