import{_ as e,o as t,c as o,e as n}from"./app.ad4da1a1.js";const l={},s=n(`<h3 id="clipperoffset-execute" tabindex="-1"><a class="header-anchor" href="#clipperoffset-execute" aria-hidden="true">#</a> <strong>ClipperOffset.Execute</strong></h3><div class="language-text ext-text"><pre class="language-text"><code>Del.\xBB procedure Execute(out solution: TPaths; Delta: Double); overload;
