<template><div><p>不管是按公历新年，还是按中国新年，在这个点说新年快乐都显得格格不入，<s>但反正也没人看也就无所谓了</s>。</p>
<!-- more -->
<hr>
...
<h2 id="有书读且活着" tabindex="-1"><a class="header-anchor" href="#有书读且活着" aria-hidden="true">#</a> 有书读且活着</h2>
...
<p>好耶！</p>
<h2 id="国企" tabindex="-1"><a class="header-anchor" href="#国企" aria-hidden="true">#</a> 国企</h2>
...
<p>就是这公司离家有点远，坐地铁得一个多小时。我用坐地铁的时间把王树森老师的 <a href="https://github.com/wangshusen/DRL" target="_blank" rel="noopener noreferrer">Deep Reinforcement Learning</a> 看了一遍，<s>并通过找 typos 让自己的名字出现在了这本书的致谢里</s>。然后脑子一热去继续学了一下强化学习，当时甚至还燃起了要写一个“极简强化学习库”的热情，因为觉得即使是当时主打轻量的 RL 库，为了兼顾某些方面也必须做出取舍，最终也还是不够简洁。而我只是想要一些最核心的功能来方便我玩耍，只要把这些最核心的功能写得干净高校且方便扩展就好了。结果不了了之，一方面没有精力，另一方面我对 RL 各种算法和现有的库的架构的了解都太少了，感觉很难写出我想写的东西。后来也没再学 RL 了，感觉我现在连贝尔曼方程都看不懂了。</p>
<h2 id="找实习" tabindex="-1"><a class="header-anchor" href="#找实习" aria-hidden="true">#</a> 找实习</h2>
...
<p>摸鱼之年贯彻得非常好。</p>
<h3 id="简历" tabindex="-1"><a class="header-anchor" href="#简历" aria-hidden="true">#</a> 简历</h3>
<p>我第一次实习的公司是个游戏公司，直接要求“不要发那种中规中矩的简历过来”，于是我写了<a href="https://resume.zxh.io/" target="_blank" rel="noopener noreferrer">这个</a>发过去。第二次实习在国企，感觉对面也没怎么看我简历。因此这可以说是我第一次正经的给公司投简历。</p>
<p>简历我之前就用 LaTeX 自娱自乐性质的写过一份，直接用了 <a href="https://ctan.org/pkg/moderncv" target="_blank" rel="noopener noreferrer">moderncv</a> 宏包的 classic style，好看是好看，但每节的标题单独占了一列，太不紧凑了，装不下多少内容。尤其是投工业届的简历往往被建议只写一页（虽然也没人明确地告诉过我写两页到底会不会有什么负面影响），那更是寸土寸金。我也懒得调整了，直接换成了<a href="https://github.com/billryan/resume/" target="_blank" rel="noopener noreferrer">这个</a>更紧凑的模板，然后魔改了一下，主要是扔掉了图标和给标题加了颜色，最后成品长这样：<a href="https://zxh.io/files/cv/cn/brief.pdf" target="_blank" rel="noopener noreferrer">中文</a> / <a href="https://zxh.io/files/cv/en/brief.pdf" target="_blank" rel="noopener noreferrer">英文</a>。英文简历除了 MSRA 应该也没公司看，但反正写都写了，我就把它拼在中文简历后面了。</p>
...
<li>如果要出现超链接，那么考虑到对方是拿着纸质简历在看的可能性，应该尽量用文字把核心信息写清楚。比如你要放个人网站链接，就直接把域名打上去：<a href="https://zxh.io" target="_blank" rel="noopener noreferrer">zxh.io</a>，如果写成这样：<a href="https://zxh.io" target="_blank" rel="noopener noreferrer">个人网站</a>，打印在纸上就没人知道这是什么了；如果放 Github 一类的主页，起码把平台名和用户名写上去</li>
...
<h3 id="面试" tabindex="-1"><a class="header-anchor" href="#面试" aria-hidden="true">#</a> 面试</h3>
...
<p><s>可是所有公司 hr 的声音都好好听啊。</s></p>
<h2 id="旅游" tabindex="-1"><a class="header-anchor" href="#旅游" aria-hidden="true">#</a> 旅游</h2>
<p>作为一个死宅，去年我就出去丸了三次。现在想来，那是我出国前最后一次见这些朋友们。</p>
<h3 id="成都" tabindex="-1"><a class="header-anchor" href="#成都" aria-hidden="true">#</a> 成都</h3>
...
<p>和像鬼一样飘着的金茂大厦：</p>
<p><img src="/img/in-post/2022-02-21/shanghai-2.jpg" alt="shanghai-2"></p>
<p>上了大学四年都没上过的东方明珠，在塔底的时候天气还行，等排队排上去时就开始乌云密布电闪雷鸣，甚至能看到闪电在环球金融中心上的倒影，感觉随便拍一张照片就能拉去当上海堡垒的海报：</p>
<p><img src="/img/in-post/2022-02-21/shanghai-3.jpg" alt="shanghai-3"></p>
<p>去了大学四年都没去过的迪士尼，见到了尼克·王尔德：</p>
<p><img src="/img/in-post/2022-02-21/shanghai-4.jpg" alt="shanghai-4"></p>
<p>啊他真的太帅了！</p>
...
<p>骑车去追逐了落日：</p>
<p><img src="/img/in-post/2022-02-21/shenzhen-1.jpg" alt="shenzhen-1"></p>
...
<h2 id="快手" tabindex="-1"><a class="header-anchor" href="#快手" aria-hidden="true">#</a> 快手</h2>
...
<p>我感觉这段实习就像在读研，天天看论文写代码跑实验，然后每周一次组会汇报进度。而组会也很有快手特色，我花了很久才能在看到别人的周报上出现的美女和土味短视频时保持冷静而不是笑出声。<s>我不玩快手，我只在周报上看快手短视频。</s></p>
...
<h2 id="北京" tabindex="-1"><a class="header-anchor" href="#北京" aria-hidden="true">#</a> 北京</h2>
<p>北京是个不适合人类生存的地方。</p>
...
<h2 id="deecamp" tabindex="-1"><a class="header-anchor" href="#deecamp" aria-hidden="true">#</a> Deecamp</h2>
...
<hr>
<p>因为被导师<s>委婉</s>直接的评价过深度学习和数学基础不扎实，于是想要把深度学习里面的各种操作手写一遍，遂写了 <a href="https://github.com/Renovamen/flint" target="_blank" rel="noopener noreferrer">Flint</a>。因为 API 和结构对标 PyTorch，所以我就厚颜无耻的叫它 homemade PyTorch 了，甚至还在 README 里放了一张梗图：</p>
...
<p>一个是博客主题 Gungnir。这最开始是一个 Jekyll 主题，风格严重受到了 <a href="https://github.com/Huxpro/huxpro.github.io" target="_blank" rel="noopener noreferrer">Hux</a> 和 <a href="https://github.com/mashirozx/sakura" target="_blank" rel="noopener noreferrer">Sakura</a> 的影响。2020 年的时候我看着我当年啥都不懂的时候魔改的代码感到心烦意乱，而且不知为何我折腾了几次都没用弄好热加载，每次改代码都要手动刷新，更烦，遂决定用 VuePress 重写。去年我学了 React，学完以后我迅速被 Vue 3 的理念说服了并开始无法忍受 Vue 2 的写法。那时 VuePress 1 已经不再更新，基于 Vue 3 的 VuePress 2 进了 beta 阶段。用 Webpack 打包的 VuePress 1 的启动速度太慢了，而 Vite 真的太快了。而且 VuePress 1 不再更新以后，Github 的 Dependabot 天天给我报 alert。综上，去年年底的时候我又把它用 VuePress 2 重写了一遍。</p>
<p>不知为何它现在已经一百多个 star 了，还会有人提 issue 和 pr。有点出乎意料，虽然我不是没有想象过它被人发现的一天，但我最开始的期望只是自己用用就行。</p>
<p>另一个是 Vue 图标组件 <a href="https://github.com/Renovamen/oh-vue-icons" target="_blank" rel="noopener noreferrer">oh-vue-icons</a>，它可以让你方便的从不同图标库里引入图标。这也是 2020 年开始写的项目，当时觉得在博客里处理不同图标库的图标太过麻烦，于是写了这个出来。去年的时候让它支持了 Vue 3，最初的实现是单独再写一份 Vue 3 版本的代码，后来通过 <a href="https://github.com/vueuse/vue-demi" target="_blank" rel="noopener noreferrer">vue-demi</a> 实现了在一份代码里同时支持 Vue 2 和 3。</p>
<hr>
<p>其他：</p>
<ul>
<li>
<p>把当年找实习时写的看上去像个 RPG 游戏实际上是个抽卡游戏的<a href="https://github.com/Renovamen/midgard" target="_blank" rel="noopener noreferrer">简历</a>升级到了 Vue 3</p>
</li>
<li>
<p>还在国企实习时写的摸鱼网站 <a href="https://github.com/Renovamen/Fishmail" target="_blank" rel="noopener noreferrer">Fishmail</a>，可以装作正在看 Gmail 的样子看知乎日报摸鱼</p>
...
<li>
<p>重构了大三为了抵软件测试期末项目在实验室搬砖时写的<a href="https://github.com/Renovamen/Speech-Emotion-Recognition" target="_blank" rel="noopener noreferrer">语音情感识别</a>，不知为何它的 star 越来越多，现在在 Github 上搜关键词，它甚至会出现在前三位</p>
<p>上学期我发现同济软院新开了一门课叫语音识别，其期末项目是语音情感识别，只要这门课一直开，我的 star 就能一直涨（狗头</p>
</li>
<li>
<p>在快手天天跟 Transformer 的 masked attention 拉扯时顺手写的带 mask 的 tensor 操作库 <a href="https://github.com/Renovamen/torchmasked" target="_blank" rel="noopener noreferrer">torchmasked</a></p>
<p>除了我以外并没有人在用</p>
</li>
<li>
<p>因为实习在做应用所以看了一些主要贡献在 Transformer / CNN 网络结构上的论文，看完写了一下里面的核心操作：<a href="https://github.com/Renovamen/torchop" target="_blank" rel="noopener noreferrer">torchop</a></p>
<p>并没有看多少篇</p>
</li>
<li>
<p>脑子一热想要写极简 <a href="https://github.com/Renovamen/metallic" target="_blank" rel="noopener noreferrer">meta-learning</a> 和 <a href="https://github.com/Renovamen/alkaid" target="_blank" rel="noopener noreferrer">reinforcement learning</a> 库</p>
...
<hr>
<p>最后是去年最大的意外 <a href="https://github.com/Renovamen/playground-macos" target="_blank" rel="noopener noreferrer">playground-macos</a>，相当于我另一个更炫酷一点的个人主页，炫酷在于它仿了 macOS 的 UI。这是我第一个千 star 项目，并在 GitHub 和 Hacker News trending 前两位挂了两三天，让我“上一次 Github trending”的愿望提前了八年实现。</p>
...
<p>因为只是随便练手且最开始并没有想到要把它做成 portfolio，所以 repo 名字也取得非常随意，甚至当时连 create-react-app 默认生成的 <code v-pre>index.html</code> 的 title 都没改。后来做成 portfolio 是因为觉得这网站有那么多可以填充的地方，不利用太可惜了。</p>
...
<p>某次跟<a href="https://yuyanzy.github.io/" target="_blank" rel="noopener noreferrer">宇言</a>聊天的时候，我说我能让我开心起来的事，一是无忧无虑的活着，这需要一定的物质条件身体素质和社交圈子来支撑，二就是做 impactful work。我没有任何崇高而远大的理想，我不在乎我的工作能为国家为世界为科学带来怎样的贡献，我也不在乎它们能给人类的生活带来怎样的改变。我就仅仅只是，看着我的工作很 impactful，我就开心。宇言当时对此给出了一个我非常喜欢的比喻：就像一只趴在自己的金山银山上的龙，金山银山对龙来说没有任何价值，但龙就是喜欢这些亮闪闪的东西。</p>
<p>那么，希望有一天我能拥有自己的金山银山吧，嗷呜。</p>
<p><s>虽然现在我连水论文都水不好。</s></p>
